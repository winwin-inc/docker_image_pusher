...
from src.winwin_image_mirror.registry.tags import delete_image_tag, get_image_tags
...
class TestDeleteImageTag:
    ...
    @patch("src.winwin_image_mirror.registry.tags.httpx.delete")
    @patch("src.winwin_image_mirror.registry.tags.get_auth_token")
    @patch("src.winwin_image_mirror.registry.tags.httpx.get")
    def test_delete_tag_success(
        self, mock_tags_get, mock_get_auth_token, mock_delete, mock_env_vars
    ):
        """测试成功删除标签"""
    ...
    @patch("src.winwin_image_mirror.registry.tags.get_auth_token")
    @patch("src.winwin_image_mirror.registry.tags.httpx.get")
    def test_delete_tag_permission_denied(
        self, mock_tags_get, mock_get_auth_token, mock_delete, mock_env_vars
    ):
        """测试删除权限不足"""
        # Mock get_auth_token 直接返回 token
